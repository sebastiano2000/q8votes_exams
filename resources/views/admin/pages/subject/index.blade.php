        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="{{ route('subject.upsert') }}" class="btn btn-primary float-end mt-2"> <i
                                class="ti-plus"></i>
                            اضف مادة جديدة
                        </a>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="table-responsive">
                                <form class="form" action="{{ route('subject.filter') }}" method="get">
