...
<body>
    ...
    <!--            <div class="collapse navbar-collapse" id="navbarSupportedContent">-->
                    ...
                    <!--    <header class="topbar" style="height: 67px;">-->
        
                    <!--<div style="" class="logoq">-->
                    <!--    <a href="/?home=1"><img src="upload/logoq.png" alt=""></a>-->
                    <!--</div>-->
        
                <!--<a id="header_contact_us" href="https://wa.me/+96596615789"><i class="fa fa-whatsapp"></i> إتصل بنا</a>-->
